...
Definition:
hashtable - Data structure that maps keys to values for highly efficient
lookup. Here using separate chaining with a hashing function and a vector
of singly-linked lists.
STL unordered_set - hashmap implementation since C++11, allowing O(1)
insert and search. Uses separate chaining for collision resolution.
